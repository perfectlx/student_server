...
public interface CourseTeacherMapper {
    ...
    public List<CourseTeacherInfo> findCourseTeacherInfoWithTerm(@Param("tid") Integer tid,
                                                         @Param("tname") String tname,
                                                         @Param("tFuzzy") Integer tFuzzy,
                                                         @Param("cid") Integer cid,
                                                         @Param("cname") String cname,
    ...
    @Delete("DELETE FROM studentms.courseteacher WHERE cid = #{course.cid} AND tid = #{course.tid}")
    public boolean deleteById(@Param("course") CourseTeacher courseTeacher);
}
